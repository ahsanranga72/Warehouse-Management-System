<tr class="orderData dataRow{{$product->id}}" data-id="{{$product->id}}">
    ...
    <td><input value="{{$product->product_cost}}" type="number" class="form-control net-unit-cost" required min="0" name="net-unit-cost{{$product->id}}" id="net-unit-cost{{$product->id}}"></td>
