...
<tr class="orderData dataRow{{$product->id}}"  data-id="{{$product->id}}">
        ...
        <td><input type="number" class="form-control quantity" name="quantity{{$product->id}}" id="quantity{{$product->id}}"></td>
        <td class="rcvrow"><input type="number" class="form-control received " name="received{{$product->id}}" id="received{{$product->id}}"></td>
