      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form id="quickForm" method="POST" action="{{route('saleunit.store')}}">
              @csrf
              <div class="card-body">
                <div class="row">
                  <div class="form-group col-md-6">
                    <label for="name">Sale Unit Name <span class="required-field" style="color: red">*</span></label>
                  ...
                  <div class="form-group col-md-6">
                    <label for="value">Sale Unit Value <span class="required-field" style="color: red">*</span></label>
